...
import com.recommand.job.entity.ResultResponse;
import com.recommand.job.external.GitHubClient;
...
//        String itemString = client.search(lat, lon, null);
        ...
        List<Item> items = client.search(lat, lon, null); //返回所有职位信息的object, 可能会出现OutOfBoounds
        for (Item item : items) {
