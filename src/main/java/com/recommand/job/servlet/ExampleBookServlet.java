...
import com.recommand.job.entity.ExampleBook;
...
public class ExampleBookServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         * String jsonRowString = IOUtils.toString(reader);
         * System.out.println(jsonRowString);
         * JSONObject jsonRequest = new JSONObject(jsonRowString);
         */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ExampleBook book = new ExampleBook("Harry Potter and the Sorcerer's Stone", "JK Rowling",
                                           "October 1, 1998", 11.99, "USD", 309,
                                          "Harry Potter", "en_US", "0590353403");
