...
import com.recommand.job.entity.ExampleCoordinates;
import com.recommand.job.entity.ExampleJob;
...
public class ExampleJobServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("application/json"); //为了更代码robust, 有的浏览器不能解析json
