...
(function () {
    ...
    function onPositionUpdated(position) {
        // If there is no job post near your location, comment out these lines in onPositionUpdated() function
        ...
        ajax('GET', url + '?' + params, data,
            ...
            function(res) {
                ...
                if (!items || items.length === 0) {
                    lng = -71.0606848;
                    lat = 42.4378368;
                    swal("No nearby item","Located Boston","success");
                    // alert("No nearby item. located to Boston:)");
                    loadNearbyItems();
